...
export default function App() {
  ...
  // When embedded inside Scout (window.SCOUT_CONFIG is set by the host
  // page), always start in light theme to match Scout's aesthetic and
  // override any previously-saved dark preference.
  const inScout = typeof window !== 'undefined' && Boolean(window.SCOUT_CONFIG);
  const savedTheme = inScout ? 'light' : (localStorage.getItem(LS_THEME_KEY) ?? 'dark');
