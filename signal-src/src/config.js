// When mounted inside Scout, paths get the /signal/ prefix via
// import.meta.env.BASE_URL and the API base swaps to /signal-api/.
// Standalone Signal keeps the original / and /api/.
const ASSET_BASE = import.meta.env.BASE_URL || '/';
export const API_BASE =
  (typeof window !== 'undefined' && window.SCOUT_CONFIG?.apiBase) || '/api';

const d = (p) => `${ASSET_BASE}data/${p}`;
...
export const MARKETS = {
  au: {
    ...
    geojsonRes:      d('sa4.geojson'),
    geojsonBiz:      d('business-sa4.geojson'),
  },
  uk: {
    ...
    geojsonRes:      d('uk-lad.geojson'),
    geojsonBiz:      d('uk-business-lad.geojson'),
  },
  ca: {
    label:           'Canada',
    flag:            '🇨🇦',
    ...
    geojsonRes:      d('ca-cd.geojson'),
    geojsonBiz:      d('ca-business-cd.geojson'),
  },
  za: {
    label:           'South Africa',
    flag:            '🇿🇦',
    ...
    geojsonRes:      d('za-lm.geojson'),
    geojsonBiz:      d('za-business-lm.geojson'),
  },
};
