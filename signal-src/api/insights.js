...
export function buildCaPrompt(p) {
...
export function buildCaBizPrompt(p) {
...
export function buildBusinessPrompt(p) {
...
export function buildZaPrompt(p) {
...
export function buildZaBizPrompt(p) {
  const topIndustries = p.industry_distribution
    ? Object.entries(p.industry_distribution)
        .sort((a, b) => b[1] - a[1])
        .slice(0, 7)
